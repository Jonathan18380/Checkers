    ...
    if (isset($_POST['login'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            if (password_verify($pass, $row['password'])) {
                ...
                // Redirect to the Checkerboard Game page
                header("location: checkerboard.html"); // Change this to your game page URL
                exit;
            } else {
                // Password not valid
        ...
        if ($checkResult->num_rows > 0) {
            ...
            if ($insertStmt->execute()) {
                // Redirect to the Checkerboard Game page after successful registration
                header("location: game.html"); // Change this to your game page URL
                exit;
            } else {
